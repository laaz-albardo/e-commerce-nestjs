...
// import { CategoryModule, GetCategoryUseCase } from '@src/modules/category';
...
//           `${product.name} product is already registered`,
//         );
...
//         const conflictException = new ConflictException(
//           `${updateProduct.name} product is already registered`,
//         );
